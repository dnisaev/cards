...
const PersonOutline = (allProps: IconProps, ref: Ref<SVGSVGElement>) => {
  ...
  return (
    <IconWrapper
      icon={
        ...
        >
          <g clipPath={'url(#clip0_5661_1646)'}>
            <path
              d={
